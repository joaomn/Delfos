<template>
  <div style="border-bottom: 0.9px solid black">
    <div
      id="cadastro-login"
      class="flex flex-row justify-content-end gap-2 m-2 ml-0 mt-4 font-bold font-xl scalein animation-duration-2000 animation-iteration-infinite w-full"
    >
  ...
  <br />
  <div class="flex " >
  <div class="flex  flex-column w-full m-8 h-6rem mb-0 text-xl font-bold" style="border-bottom: 1px solid black;">
    <h1 style="margin-bottom: 0;">Encontre Profissionais de Confiança</h1>
...
<div class="flex flex-clumn m-4 mb-1">
    ...
    <span class="p-input-icon-left ">
        ...
        <Button label="Pesquisar " icon="pi pi-search " class="text-white border-round-xl border-none ml-3" style="background: #f45d2d; " />
        </span>
...
<div class=" grid m-2" style="width: 1200px; height: auto;">
  ...
  <div class="col">
    <Card >     
      ...
      <template #content>
          <img src="../icones/ac_unit_FILL0_wght400_GRAD0_opsz48.svg" alt="">
      </template>      
  </Card>
  </div>
  <div class="col">
    <Card >     
      ...
      <template #content>
         <img src="../icones/handyman_FILL0_wght400_GRAD0_opsz48.svg" alt="">
      </template>      
  </Card>
  </div>
  <div class="col">
    <Card >     
      ...
      <template #content>
          <img src="../icones/plumbing_FILL0_wght400_GRAD0_opsz48.svg" alt="">
      </template>      
  </Card>
  </div>
  <div class="col">
    <Card >     
      ...
      <template #content>
          <img src="../icones/baby_changing_station_FILL0_wght400_GRAD0_opsz48.svg" alt="">
      </template>      
  </Card>
  </div>
  <div class="col">
    <Card >     
      ...
      <template #content>
          <img src="../icones/apartment_FILL0_wght400_GRAD0_opsz48.svg" alt="">
      </template>      
  </Card>
  </div>
  <div class="col">
    <Card >     
      ...
      <template #content>
          <img src="../icones/bolt_FILL0_wght400_GRAD0_opsz48.svg" alt="">
      </template>      
  </Card>
  </div>
  <div class="col">
    <Card >     
      ...
      <template #content>
          <img src="../icones/local_car_wash_FILL0_wght400_GRAD0_opsz48.svg" alt="">
      </template>      
  </Card>
  </div>
  <div class="col">
    <Card >     
      ...
      <template #content>
          <img src="../icones/local_florist_FILL0_wght400_GRAD0_opsz48.svg" alt="">
      </template>      
  </Card>
  </div>
  <div class="col">
    <Card >     
      ...
      <template #content>
         <img src="../icones/window_FILL0_wght400_GRAD0_opsz48.svg" alt="">
      </template>      
  </Card>
  </div>
  <div class="col">
    <Card >     
      ...
      <template #content>
          <img src="../icones/home_repair_service_FILL0_wght400_GRAD0_opsz48.svg" alt="">
      </template>      
  </Card>
  </div>
  <div class="col">
    <Card class="flex justify-content-center aligin-content-center">     
      ...
      <template #content>
          <img src="../icones/cleaning_services_FILL0_wght400_GRAD0_opsz48.svg" alt="">
      </template>      
  </Card>
  </div>
